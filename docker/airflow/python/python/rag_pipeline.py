...
try:
    ...
    def _trace_rag_op(name: str):
        """No-op decorator when MLflow unavailable."""
        def decorator(func):
            return func
        return decorator
...
@_trace_rag_op("rag_answer_year_month")
...
@_trace_rag_op("rag_answer_extremes")
...
@_trace_rag_op("rag_answer_question")
